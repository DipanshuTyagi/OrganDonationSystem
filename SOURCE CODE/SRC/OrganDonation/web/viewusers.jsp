					...
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li class="current"><a href="viewusers.jsp">View User</a></li>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Location</strong>&emsp;</b></td>
               <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Action</strong>&emsp;</b></td>
          </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
        ...
        String Query22="select * from reg ";
                        ...
                        %>
                                <tr>  
                                  ...
                                  <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("location")%></td>
                                   <td style='font-weight: bold; color: red;'><a href='Delete_File.jsp?id=<%=rs22.getString("id")%>&&name=<%=rs22.getString("name")%>&&mobile=<%=rs22.getString("mobile")%>&&email=<%=rs22.getString("email")%> &&location=<%=rs22.getString("location")%>' style='color:Red;'>Delete</a></td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
