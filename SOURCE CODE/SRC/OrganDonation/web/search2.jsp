					...
					<div class="menu_block">
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li class="current"><a href="search2.jsp">Search</a></li>
								<li><a href="donateform.jsp">Donate Form</a></li>
...
<!--==============================Content=================================-->
			<div class="content"><div class="ic"></div>
				<div class="container_12">
					...
					<div class="grid_4">
						<a href="#" class="donate">Search</a>
					
                                                <form action="search3.jsp" method="POST">
                                                    <br><br> <br>
                                                    <center>
                                                     Enter Your Search : (like Eye, heart) <br> <br>
                                                     <input type="text" style="background-color: #7eea3d;width: 200px;" name="search"><br><br>
                                                    </center>
