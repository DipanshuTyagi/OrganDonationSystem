...
<!--==============================Content=================================-->
			<div class="content"><div class="ic"></div>
				<div class="container_12">
					...
					<div class="grid_4">
						<a href="#" class="donate">User SignUp</a><br><br>
<form name="myform" method="post" action="reg.jsp" onsubmit="return validateform()" >  
    UserName : &nbsp;&nbsp;&nbsp;<input type="text" style="background-color: #7eea3d;width: 200px;" name="name"><br><br>
Password : &nbsp;&nbsp; &nbsp;<input type="password" style="background-color: #7eea3d;width: 200px;" name="password"><br><br/>  
Mobile No :&emsp;&nbsp;<input type="text" style="background-color: #7eea3d;width: 200px;" name="mobile"><br><br>
Email Id : &emsp;&nbsp;&nbsp;&nbsp;<input type="email" style="background-color: #7eea3d;width: 200px;" name="email" value="" required="" /><br><br>
Location : &emsp;&nbsp;&nbsp;<input type="text" style="background-color: #7eea3d;width: 200px;" name="location"> &emsp;&emsp;<br>
Country : &emsp;&nbsp;&nbsp;&nbsp;<input type="text" style="background-color: #7eea3d;width: 200px;" name="country"><br><br/>  
<center>
