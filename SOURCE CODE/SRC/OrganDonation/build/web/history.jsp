						...
						<nav class="horizontal-nav full-width horizontalNav-notprocessed">
							<ul class="sf-menu">
								...
								<li><a href="viewusers.jsp">View User</a></li>
								 <li class="current"><a href="history.jsp">User History</a></li>
								<li><a href="sear.jsp">Search</a></li>
...
<!--==============================Content=================================-->
			<div class="content"><div class="ic"></div>
				<div class="container_12">
						<center>					
    <h1>Users Search History</h1><br><br>		
					  <%
        try{        
    %>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;&emsp;User Name  </strong>&emsp;</b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Search Query</strong>&emsp;</b></td>
          </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
        ...
        String Query22="select * from his";
                        ...
                        %>
                                <tr>  
                                    ...
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;&emsp;&emsp;&emsp;<%=rs22.getString("name")%></td>
                                  <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=rs22.getString("keyword")%></td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
