...
<!--==============================Content=================================-->
			<div class="content"><div class="ic"></div>
				<div class="container_12">
					...
					<div class="grid_4">
						<a href="#" class="donate">Send Request</a>
						<form action="mm.jsp" method="POST">
                                                    <br><br> <br>
                                                    <center>
                                                     Enter Your Mail id :  <br> <br>
                                                     <input type="text" style="background-color: #7eea3d;width: 200px;" name="email"><br><br>
                                                    </center>
                                                     <br> <center> <input type="submit" value="Send Request" /></center>
                                                <br><br>
                                               </form>
                                        </div>
					<div class="clear"></div>
