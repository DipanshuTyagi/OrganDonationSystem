...
<%@page import="com.EncryptDecrypt"%>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
             ...
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;&emsp;&emsp;&emsp;Mobile </strong>&emsp;</b></td>
             <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;&emsp;Age</strong>&emsp;</b></td>                
            <td  style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&emsp;Request</strong></b>&emsp;</td>
         </tr>
         <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<% 
        ...
        String Query22="select * from det where part like '%"+part+"%' ";
                        ...
                        %>
                                <tr>  
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=ee.Encrypt(rs22.getString("name"))%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;&emsp;<%=ee.Encrypt(rs22.getString("mobile"))%></td>
                                    <td  style="color:#080606;font-weight: bold;">&emsp;&emsp;<%=ee.Encrypt(rs22.getString("age"))%></td>   
                                    <td>&emsp;&emsp;<a href="req.jsp"  >Send</a>&emsp;</td>
                                <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
